...
import { registerForEvent, getRegistrations, getMyRegistrations, updateRegistrationStatus } from "../controllers/registrationController.js";
import auth from "../middleware/authMiddleware.js";

router.post("/", auth("student"), registerForEvent);
router.post("/:eventId", auth("student"), registerForEvent);
router.get("/me", auth("student"), getMyRegistrations);
